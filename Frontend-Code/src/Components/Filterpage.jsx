        ...
        return (
            <React.Fragment>
                ...
                <div className="container" style={{ marginTop: "2%" }}>
                    ...
                    <h1 className="filter-heading" style={{ fontWeight: "bold", fontSize: "36px", margin: '0 0 20px 0', color: '#192f60' }}>{this.state.option} Places in Vellore</h1>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            ...
                            <div style={{ boxShadow: "0 3px 6px 0 rgba(0, 0, 0, 0.16)", height: "710px", padding: '17px 25px 31px 26px', marginBottom: "100px", background: "#fff" }} id="demo" className="collapse show" >
                                ...
                                <div className="checkbox">
                                    <label><input type="checkbox" onChange={() => this.handleCuisineChange(5)} />Continental</label>
                                </div>
                                <div className="checkbox">
                                    <label><input type="checkbox" onChange={() => this.handleCuisineChange(5)} />Italian-American</label>
                                </div>

                                {/* This is for cost for tow radio box. */}
                                <div style={{ fontWeight: "normal", fontSize: '14px', marginTop: '30px', color: '#192f60' }}>Combo for Two Persons</div>
                                <div className="radio">
